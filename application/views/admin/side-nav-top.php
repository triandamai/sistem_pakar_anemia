          ...
          <ul class="sidebar-menu">     
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="#">Data Gejala</a></li>
                  <li><a class="nav-link" href="#">Tambah Gejala</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-th"></i> <span>Penyakit</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="#">Data Penyakit</a></li>
                  <li><a class="nav-link" href="#">Tambah Penyakit</a></li>
                  <li><a class="nav-link" href="#">Data Saran Penyakit</a></li>
                  <li><a class="nav-link" href="#">Tambah Saran Penyakit</a></li>
                </ul>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="components-article.html">Data Artikel</a></li>
                  <li><a class="nav-link beep beep-sidebar" href="components-avatar.html">Tambah Artikel</a></li>
                </ul>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="beep beep-sidebar" href="#">History</a></li>
                </ul>
              </li>
